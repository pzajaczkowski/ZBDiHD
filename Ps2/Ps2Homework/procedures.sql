...
CREATE OR REPLACE FUNCTION F_GET_STATE_PROFIT(P_STATE LOCALIZATIONS.STATE%TYPE, P_YEAR NUMBER) RETURN NUMBER IS
    PROFIT NUMBER;
BEGIN
...
SELECT F_GET_STATE_PROFIT('CALIFORNIA', 2014) FROM DUAL;
